import {
  type AnalyticKPIData,
  type ClientLocation,
  type OSUserData,
  type SessionByOSData,
  type TopCampaignsData,
  type UserByCohortData,
  type UserByCountryData,
  type UserEngagementChartData,
  type UserEngagementTab,
} from "@root/types/dashboard";
...
export const userEngagementChartData: UserEngagementChartData = {
  newUser: {
    actual: [
      48458, 59261, 53556, 68184, 34439, 45729, 30668, 33356, 58359, 46298,
      40294, 55000, 50854, 49839, 53560, 39428, 51885, 45606, 67112, 47288,
    ],
    projected: [
      60011, 76108, 62186, 76185, 55675, 55579, 41574, 70346, 30044, 41786,
      30712, 63402, 45871, 62857, 48390, 48801, 53452, 76411, 55450, 32191,
    ],
  },
  avgSession: {
  ...
  subscribers: {
    actual: [
      673376, 1393866, 514229, 540505, 552731, 935344, 1009759, 1430342, 925869,
      838345, 559880, 1430771, 1082764, 1012778, 1230272, 1022238, 1308372,
      1103138, 1109148, 834265,
    ],
    projected: [
      1382780, 744987, 955123, 630721, 552345, 1041834, 510343, 917766, 824350,
      1427699, 692779, 1011717, 832913, 1191009, 1067323, 1192070, 515341,
      564620, 1471685, 692878,
    ],
  },
  pageViews: {
    actual: [
      130768, 229964, 247511, 275619, 220999, 251273, 285853, 239383, 257941,
      145971, 154547, 134104, 150520, 280825, 253793, 275212, 187087, 254150,
      152188, 185579,
    ],
    projected: [
      120553, 227355, 181531, 235976, 247717, 299365, 214921, 267551, 121081,
      118930, 272410, 200217, 289031, 280382, 113487, 286664, 196646, 216526,
      253414, 193437,
    ],
  },
};
