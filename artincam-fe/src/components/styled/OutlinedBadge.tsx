import { Badge, type BadgeOwnProps, badgeClasses, styled } from "@mui/material";
...
const OutlinedBadge = styled(
  ...
  const borderColor =
    outlineOptions?.color || theme.vars.palette.background.paper;
  return {
    [`&.${badgeClasses.badge}`]: {
      "&::after": {
        position: "absolute",
