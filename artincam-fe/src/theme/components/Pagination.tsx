...
const NextIcon = () => (
  <IconifyIcon icon="material-symbols:chevron-right-rounded" fontSize={20} />
);
const previousIcon = () => (
  <IconifyIcon icon="material-symbols:chevron-left-rounded" fontSize={20} />
);

// @ts-expect-error MUI variant theme typed as unknown
const paginationCustomVariants: ComponentsVariants["MuiPaginationItem"] =
...
export const PaginationItem: Components<
        ...
        variants: [
          {
            ...
            style: (
              ...
              const paletteColor = theme.vars.palette[
                colorKey
              ] as PaletteColor & PaletteColorChannel;
              return {
                [`&.${paginationItemClasses.selected}, &.${paginationItemClasses.selected}:hover`]:
                  {
